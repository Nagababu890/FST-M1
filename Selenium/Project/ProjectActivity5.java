...
public class ProjectActivity5 {
    ...
    public void beforeClass() {
        ...
        driver.get("http://alchemy.hguy.co:8080/orangehrm");   // ✅ Correct URL
    ...
    public void editUserInfo() throws InterruptedException {
        ...
        driver.findElement(By.id("btnLogin")).click();   // ✅ Correct locator
        ...
        // Step 6: Set Nationality (dropdown)
        Select nationDropdown = new Select(driver.findElement(By.id("personal_cmbNation")));
        nationDropdown.selectByVisibleText("Indian");
