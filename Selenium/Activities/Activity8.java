...
public class Activity8 {
    public static void main(String[] args) {
        ...
        builder.click(cargoLock).pause(Duration.ofSeconds(2)).moveToElement(cargoToml).pause(Duration.ofSeconds(2)).click(cargoToml).build().perform();
        ...
        builder.doubleClick(srcButton).pause(Duration.ofSeconds(2)).pause(Duration.ofSeconds(2))
        .contextClick(targetButton).pause(Duration.ofSeconds(2)).build().perform();
        // and then open it
        builder.click(driver.findElement(By.xpath("//div[@id='menu']/div/ul/li[1]"))).pause(Duration.ofSeconds(2)).build().perform();
        // Print the front side text
